...
public class EditAreaOfInterestController : Controller
{
    ...
    public async Task<IActionResult> Post(SubmitAreaOfInterestModel command, CancellationToken cancellationToken)
    {
        ...
        updateMemberProfileAndPreferencesRequest.patchMemberRequest = null;
        updateMemberProfileAndPreferencesRequest.updateMemberProfileRequest.Profiles = command.AreasOfInterest.Select(x => new UpdateProfileModel()
        {
