...
public class AmbassadorProfileController : Controller
{
    ...
    public async Task<IActionResult> Index(CancellationToken cancellationToken)
    {
        ...
        AmbassadorProfileViewModel model = new(personalDetails, memberProfiles.Result.Email, memberProfiles.Result.Profiles, memberProfiles.Result.Preferences, apprenticeshipDetails, profiles.Result.Profiles, Url.RouteUrl(SharedRouteNames.MemberProfile)!, Url);
