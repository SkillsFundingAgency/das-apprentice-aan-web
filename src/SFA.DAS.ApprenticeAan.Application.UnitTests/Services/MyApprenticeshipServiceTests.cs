...
public class MyApprenticeshipServiceTests
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        clientMock.Verify(o => o.GetStagedApprentice(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<CancellationToken>()), Times.Never);
        ...
        CancellationToken cancellationToken)
    {
        ...
        clientMock.Setup(c => c.GetStagedApprentice(lastName, dateOfBirth.ToString("yyyy-MM-dd"), email, cancellationToken)).ReturnsAsync(stagedApprenticeOkResponse);
        ...
        clientMock.Verify(o => o.GetStagedApprentice(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<CancellationToken>()));
